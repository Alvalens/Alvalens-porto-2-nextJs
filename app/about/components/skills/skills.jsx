...
const skillCategories = {
	web: {
		...
		tools: ["Visual Studio Code", "Git", "Github","Vite", "Docker", "Kubernetes", "Google Cloud", "Postman"],
	},
	api: {
		title: "REST API",
		icon: WebhookIcon,
		...
		tools: ["Postman", "Docker", "Kubernetes", "Swagger", "Git", "Github", "Google Cloud", "AWS"],
	},
	ai: {
		title: "Cybersecurity",
		icon: ActivityIcon,
		description: "Offsec, Pentesting, Bug Bounty Hunting",
		Technique: [
			"Python",
			"shell scripting",
			"injection attacks",
