...
const skillCategories = {
	control: {
		...
		icon: ActivityIcon,
		description: "Model-based and optimization-based control design",
		languages: [
			{ name: "Model Predictive Control (MPC)", highlight: true },
			{ name: "Nonlinear Control", highlight: true },
			{ name: "State Estimation", highlight: true },
			{ name: "System Modeling", highlight: true },
			{ name: "Stability Analysis", highlight: false },
		],
		tools: ["MATLAB", "Simulink", "Control Toolbox"],
	},

	robotics: {
		title: "Robotics",
		icon: CodepenIcon,
		description: "Modeling, control, and planning for robotic systems",
		languages: [
			{ name: "Robot Kinematics & Dynamics", highlight: true },
			{ name: "Trajectory Planning (LSPB, PRM)", highlight: true },
			{ name: "Self-balancing Robots", highlight: true },
			{ name: "Point Cloud Registration (ICP)", highlight: false },
		],
		tools: ["ROS2", "Gazebo", "PyBullet"],
	},

	datadriven: {
		title: "Data-Driven Control",
		icon: WebhookIcon,
		description: "Learning-based and probabilistic control methods",
		languages: [
			{ name: "Gaussian Process Modeling", highlight: true },
			{ name: "Tensor Train Decomposition", highlight: true },
			{ name: "System Identification", highlight: true },
			{ name: "Optimization-Based Learning", highlight: false },
		],
	...
	ml: {
		...
		icon: MobileIcon,
		description: "Reinforcement learning for robotics and control",
		languages: [
			{ name: "Reinforcement Learning (PPO, DDPG, TD3)", highlight: true },
			{ name: "Neural Networks (MLP, LSTM)", highlight: true },
			{ name: "Sim-to-Real Transfer", highlight: false },
		],
